...
global.botname = config.botName || "CYBER-PANDA-MD";
global.themeemoji = "•";
    ...
    try {
                        ...
                        await QasimDev.sendMessage(mek.key.remoteJid, {
                            ...
                            contextInfo: {
                                ...
                                forwardedNewsletterMessageInfo: {
                                    ...
                                    newsletterName: 'ᴄʏʙᴇʀ x ꜱᴀᴄʜɪʏᴀ',
                                    serverMessageId: -1
                                }
                            }
                        }).catch(console.error);
        ...
        if (pairingCode && !isRegistered) {
            ...
            if (config.pairingNumber) {
                ...
                phoneNumberInput = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: +94702782946 (without + or spaces) : `)));
            } else {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    await QasimDev.sendMessage(botNumber, {
                        text: `*Bot සාට්තකව ඩිප්ලොයි වී ඇත.*\n\n⏰ Time: ${new Date().toLocaleString()}\n✅ Status: Online and Ready!${ghostStatus}\n\n✅Make sure to join below channel`,
                        contextInfo: {
                            forwardingScore: 1,
                            isForwarded: true,
                            forwardedNewsletterMessageInfo: {
...
async function main() {
    ...
    printLog('info', 'Starting CYBER PANDA MD BOT...');
